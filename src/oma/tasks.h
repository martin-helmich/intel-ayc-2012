...
/**
 * @brief Computes all possible paths between two locations.
 *
...
public:
	...
	/**
	 * @brief Executes the "find path" task.
	 */
	task* execute();
};

/**
 * @brief Solves the "work hard" problem.
 *
...
public:
	...
	/**
	 * @brief Creates a new "work hard" task.
	 *
	...
	/**
	 * @brief Executes the "work hard" task.
	 *
...
/**
 * @brief Solves ONE specific of the "play hard" problems.
 *
...
public:
	...
	/**
	 * @brief Creates a new "play hard" task.
	 *
	...
	/**
	 * @brief Executes the "play hard" task.
	 *
...
/**
 * @brief Task for creating a specific subset of the "play hard" solution.
 *
...
public:
	...
	/**
	 * @brief Creates a new "play hard merge" task.
	 *
	...
	/**
	 * @brief Executes the "play hard merge" task.
	 */
	task* execute();
};
